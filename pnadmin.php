...
function Feeds_admin_new()
{
    ...
    $render->assign('enablecategorization', ModUtil::getVar('Feeds', 'enablecategorization'));
...
function Feeds_admin_view($args)
{
    ...
    $render->assign('pager', array('numitems' => ModUtil::apiFunc('Feeds', 'user', 'countitems', array('category' => isset($catFilter) ? $catFilter : null)),
