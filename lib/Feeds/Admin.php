...
class Feeds_Admin extends Zikula_Controller
{
    /**
    ...
    public function main()
    {
        ...
        return $this->renderer->fetch('feeds_admin_main.htm');
    }
    ...
    public function newfeed()
    {
        ...
        $this->renderer->assign('enablecategorization', ModUtil::getVar('Feeds', 'enablecategorization'));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('feeds_admin_newfeed.htm');
    }
    ...
    public function modify($args)
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('feeds_admin_modify.htm');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // assign the item id.
            $this->renderer->assign('fid', $fid);

            // Return the output that has been generated by this function
            return $this->renderer->fetch('feeds_admin_delete.htm');
        }
    ...
    public function view($args)
    {
        ...
        $this->renderer->assign('feedsitems', $feedsitems);
        ...
        if ($modvars['enablecategorization']) {
            ...
            $this->renderer->assign('numproperties', count($propArray));
            $this->renderer->assign('properties', $propArray);
            $this->renderer->assign('property', $property);
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('feeds_admin_view.htm');
    }
    ...
    public function modifyconfig()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('feeds_admin_modifyconfig.htm');
    }
